...
date_re = re.compile(r'<article role="article" class="decision-detaillee-item-article">\s*<div class="decision-content decision-content--main">\s*<h1>(?P<decision_date>[^<]*)<br>\s*')
